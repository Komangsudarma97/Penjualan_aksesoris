    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">Sinar Ban</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'kategori'?>"><i class="fa fa-desktop"></i> Data Kategori Barang</a>
                    </li>
					<li>
                        <a href="<?php echo base_url().'barang'?>"><i class="fa fa-bar-chart-o"></i> Data Barang</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'operator'?>"><i class="fa fa-qrcode"></i> Data Admin</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'transaksi'?>"><i class="fa fa-edit"></i> Data Transaksi </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url().'auth/logout'?>"><i class="fa fa-fw fa-file"></i> Log Out</a>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>Website : <a href="#" target="_blank">SinarBan</a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
    <!-- /. WRAPPER  -->
