                <div class="row">
                    <div class="col-md-12">
                        ...
                        Sinar Ban Abadi <small>Laporan Transaksi</small>
                        </h2>
                    </div>
                </div> 
                <!-- /. ROW  -->
                            ...
                            <div class="panel-body">
                                <?php echo form_open('transaksi/laporan', array('class'=>'form-inline')); ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal1" class="form-control" placeholder="Tanggal Mulai Pemesanan">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail2"> - </label>
                                        <input type="text" name="tanggal2" class="form-control" placeholder="Tanggal Selesai Pemesanan">
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <?php $no=1; $total=0; foreach ($record->result() as $r){ ?>
                                            <tr class="gradeU">
                                                ...
                                                <td>Rp. <?php echo number_format($r->total,3) ?></td>
                                            </tr>
