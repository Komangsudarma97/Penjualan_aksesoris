                <div class="row">
                    <div class="col-md-12">
                        ...
                        Sinar Ban Abadi <small>Tambah Data Barang</small>
                        </h2>
                    </div>
                </div> 
                <!-- /. ROW  -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label>Harga</label>
                                    <input class="form-control" name="harga" placeholder="Masukan Harga">
                                </div>
                                <div class="form-group">
                                    <label>Gambar</label>
                                    <input class="form-control" name="gambar" placeholder="Masukan Gambar">
                                </div>
